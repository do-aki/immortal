...
/* If you declare any globals in php_immortal.h uncomment this:
...
const zend_function_entry immortal_functions[] = {
	PHP_FE(confirm_immortal_compiled,	NULL)		/* For testing, remove later. */
...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("immortal.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_immortal_globals, immortal_globals)
    STD_PHP_INI_ENTRY("immortal.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_immortal_globals, immortal_globals)
PHP_INI_END()
*/
/* }}} */
...
{
	immortal_globals->global_value = 0;
	immortal_globals->global_string = NULL;
}
*/
/* }}} */
...
/* {{{ proto string confirm_immortal_compiled(string arg)
   Return a string to confirm that the module is compiled in */
PHP_FUNCTION(confirm_immortal_compiled)
{
	char *arg = NULL;
	int arg_len, len;
	char *strg;
	...
	len = spprintf(&strg, 0, "Congratulations! You have successfully modified ext/%.78s/config.m4. Module %.78s is now compiled into PHP.", "immortal", arg);
